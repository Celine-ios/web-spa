  ...
  * {
  ...
  <section class="container">
      <div style="width: 98%;display: flex; flex-direction: row;">
        <div style="width: 80%;">
          <img src="<?php echo e(url('images/flecha-banner.png')); ?>" alt="flecha-banner" style="position: absolute;top: 9%;left: 5.501%;">
          <img src="<?php echo e(url('images/banner-principal.jpg')); ?>" alt="banner-principal" style="width: 100%;
          margin: 1%;">
          <img src="<?php echo e(url('images/flecha-banner.png')); ?>" alt="flecha-banner" style="position: absolute;top: 9%;left: 72.7%;transform:  rotate(180deg);">
        </div>
        <div style="display: flex;flex-direction: column;justify-content: space-around;margin-left:  2%;">
    <img src="<?php echo e(url('images/banner-lateralderecho.jpg')); ?>" alt="banner-lateralderecho" style="margin: 1%;height: 45%;">
    <img src="<?php echo e(url('images/banner-lateralderecho.jpg')); ?>" alt="banner-lateralderecho" style="margin: 1%;height: 45%;">
          </div>
        </div>
    <div style="display: flex;flex-direction: row;width: 98%;">
       <div style="width: 80%;padding: 1%;">
          <img src="<?php echo e(url('images/banner-promocion-grande.jpg')); ?>" alt="banner-promocion-grande" style="width: 99.4%;height: 92%;">
        </div>
        <div style="width: 20%;padding: 1% 0.2%;">
          <img src="<?php echo e(url('images/banner-promocion-pequeno.jpg')); ?>" alt="banner-promocion-pequeno" style="width: 100%;height: 91%;">
        </div>
      </div>
    </section>
   ...
   <section class="container" style="display: flex;flex-direction: row;">
      ...
      <div style="width: 50%;padding: 2%;">
        <img src="<?php echo e(url('images/imagen-nosotros.png')); ?>" alt="imagen-nosotros" style="width: 100%;">
      </div>
    </section>
   ...
   <section class="container" style="margin:  5% 2%;">
      ...
      <img src="<?php echo e(url('images/decoracion.png')); ?>" alt="decoracion">
      </div>
    </section>
   <div style="width: 100%;">
  ...
  <section class="container" style="display: flex;flex-direction: row;">
      <div style="width: 60%;">
        <img src="<?php echo e(url('images/flecha-banner.png')); ?>" alt="flecha-banner" style="position: absolute;top: 37%;left: 4.8%;">
        <img src="<?php echo e(url('images/eventos-especiales.jpg')); ?>" alt="eventos-especiales" style="width: 100%;height: 70%;" class="img-btn">
      </div>
     <div style="width: 40%;">
        <div style="margin: 14% 0% 1% 64%;">
          <a href="#"><img src="<?php echo e(url('images/boton-mas-ofertas.png')); ?>" alt="all-offers"></a>
        </div>
       <div style="position: absolute;z-index: 2;color: white;top: 36%;left: 59%;width: 31%;">
        ...
        <br>
        <a href="#">
          <img src="<?php echo e(url('images/boton-compra-eventos-especiales.png')); ?>" alt="boton-compra-eventos-especiales" class="img-btn">
        </a>
        <a href="#" style="color: #7ab527;margin-left: 59%;">Términos y condiciones</a>
        </div>
      <img src="<?php echo e(url('images/complemento-es.png')); ?>" alt="complemento" style="position:  absolute;left: 42%;margin-top: 1%;width: 56%;z-index: 1;">
       <img src="<?php echo e(url('images/flecha-banner.png')); ?>" alt="flecha-banner" style="position: absolute;top: 37%;left: 96.4%;transform:  rotate(180deg);z-index: 2;">
    </div>
    ...
    <section class="container" style="margin: 5% 2%;">
      ...
      <img src="<?php echo e(url('images/decoracion-fv.png')); ?>" alt="decoracion">
      </div>
    </section>
   <div style="width: 100%;">
      <nav class="navbar" style="margin: 0 auto;margin-top: 1%;width: 98%;color: #fff;margin: 5% 1%;">
    ...
    <section class="container">
     <div style="display: flex;flex-direction: row;">
        <img src="<?php echo e(url('images/spa1.jpg')); ?>" alt="spa1" style="margin: 1%;width: 46%;">
        <img src="<?php echo e(url('images/spa2.jpg')); ?>" alt="spa2" style="margin: 1%;width: 23%;">
        <img src="<?php echo e(url('images/spa2.jpg')); ?>" alt="spa3" style="margin: 1%;width: 23%;">
      </div>
      <div style="display: flex;flex-direction: row;">
        <img src="<?php echo e(url('images/spa2.jpg')); ?>" alt="spa2" style="margin: 1%;">
        <img src="<?php echo e(url('images/spa2.jpg')); ?>" alt="spa3" style="margin: 1%;">
        <img src="<?php echo e(url('images/spa1.jpg')); ?>" alt="spa1" style="margin: 1%;width: 50%;">
      </div>
      <div></div>
    </section>
      <div class="container">
<img src="<?php echo e(url('images/mas-fotos.png')); ?>" alt="ver-mas-fotos" style="margin-left: 1%;margin-bottom: 5%;">
    </div>
    <section class="container" style="margin:  5% 2%;">
      <div>
   ...
   <div style="width: 100%;">
    ...
    <br>
     <section class="container" style="margin-bottom: 4%;">
       <div style="display: flex;flex-direction: row;">
          <img src="<?php echo e(url('images/eventos-especiales.jpg')); ?>" alt="eventos-especiales" style="width: 59%;height: 70%;" class="img-btn">
          ...
          <img src="<?php echo e(url('images/complemento-banner.png')); ?>" alt="complemento-banner" style="width: 91%;position:  absolute;">
         <div>
         <img src="<?php echo e(url('images/llamar-cotizar.png')); ?>" alt="llama-cotiza" style="position:  absolute;top: 76.7%;left: 46%;" class="img-btn">  
          </div>
       </div>
     </section>
    <section class="container" style="margin:  5% 5%;">
      ...
      <img src="<?php echo e(url('images/decoracion-aliados.png')); ?>" alt="decoracion">
      </div>
    </section>

  <section class="container" style="display:  flex;justify-content:  space-between;margin: 2% 0%;width: 100%;">
      <img src="<?php echo e(url('images/flecha-aliados.png')); ?>" alt="flecha-izquierda" style="margin-right: 4%;">
      <img src="<?php echo e(url('images/logo-aliados.png')); ?>" alt="logo-aliados" style="margin: 0% 4%;">
      <img src="<?php echo e(url('images/logo-aliados.png')); ?>" alt="logo-aliados" style="margin: 0% 4%;">
      <img src="<?php echo e(url('images/logo-aliados.png')); ?>" alt="logo-aliados" style="margin: 0% 4%;">
  <img src="<?php echo e(url('images/flecha-aliados.png')); ?>" alt="flecha-derecha" style="transform: rotate(180deg);margin-left:  4%;">
    </section>

 <section class="container" style="margin: 6% 2% 0% 2%;">
      <div>
      <h1 style="font-size: 2.8em;margin-bottom: 1%;margin-left: 1.5%;">EXPLORE BOGOTÁ</h1>
      <img src="<?php echo e(url('images/decoracion-bogota.png')); ?>" alt="decoracion">
      </div>
      <br>
      <div class="container" style="margin: 1% 6%;">
        ...
        <img src="<?php echo e(url('images/recuadro-bogota.jpg')); ?>" alt="recuadro-bogota">
        <img src="<?php echo e(url('images/mapa.jpg')); ?>" alt="mapa-bogota">
      </div>
    </section>
    <br>
