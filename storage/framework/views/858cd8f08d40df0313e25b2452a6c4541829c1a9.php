...
.img-container:hover:before {
  ...
  .img-spa {
   ...
   <section style="margin-top: 5%;">
      ...
      <li style="margin: 1%;"><a href="#">CENTRO DE EVENTOS</a></li>
      <li style="margin: 1%;"><a href="#">BLOG</a></li>
      <li style="margin: 1%;"><a href="#">CONTÁCTENOS</a></li>
      </ul>
      </nav>
    </section>
   ...
   <section class="container" style="width: 100%;margin-top: 4%;">
    ...
    <img src="<?php echo e(url('images/flecha-banner.png')); ?>" alt="left-arrow" style="position: absolute;left: 8.3%;top: 12%;">
    	<img src="<?php echo e(url('images/banner-principal-spa.jpg')); ?>" alt="banner-principal-spa">
    	<img src="<?php echo e(url('images/flecha-banner.png')); ?>" alt="right-arrow" style="transform: rotate(180deg);position: absolute;left: 90.08%;top: 12%;">
    	</div>
    </section>
	<section class="container" style="width: 100%;display:  flex;justify-content:  center;">
    	<img src="<?php echo e(url('images/banner-secundario-spa.jpg')); ?>" alt="banner-secundario-spa">
    </section>
   <section class="container" style="width: 100%;margin-top: 20%;display:  flex;justify-content:  flex-start;background-image: url('<?php echo e(url('images/fondo.jpg')); ?>');background-repeat: no-repeat;background-position: center; background-size: cover;margin-bottom: 20%;">
    		...
    		<div>
    		<img src="<?php echo e(url('images/imagen-nosotros.jpg')); ?>" alt="banner-peluqueria" style="width: 44%;position:  absolute;top: 29%;left: 51%;">
    		</div>
    		<br>
    	<section class="container">
      		<div>
      		<h1 style="font-size: 2.8em;margin-bottom: 1%;">NUESTROS SERVICIOS</h1>
      		<img src="<?php echo e(url('images/decoracion-spa.png')); ?>" alt="decoracion" style="width: 37%;">
      		</div>
    	</section>

    	<section class="container" style="width: 100%;display: flex;flex-wrap: wrap;margin-top: 8%;">
    		<div class="img-container">
    			<img src="<?php echo e(url('images/spa-photo.jpg')); ?>" class="img-spa">
    		</div>
    		<div class="img-container">
    			<img src="<?php echo e(url('images/spa-photo.jpg')); ?>" class="img-spa">
    		</div>
    	...
    	<section class="container" style="width: 100%;padding: 2%;margin-top: 2%;margin-bottom: 2%;">
    		<img src="<?php echo e(url('images/banner-promocion-grande.jpg')); ?>" style="width: 100%;">
    	</section>

    	<section class="container" style="margin-top: 15%;margin-bottom: 5%;">
      		<div>
      		<h1 style="font-size: 2.8em;margin-bottom: 1%;">NUESTROS PLANES</h1>
      		<img src="<?php echo e(url('images/decoracion-spa.png')); ?>" alt="decoracion" style="width: 32.4%;">
      		</div>
    	</section>

  <section class="container" style="display: flex;flex-direction: row;">
      <div style="width: 60%;">
       <img src="<?php echo e(url('images/flecha-banner.png')); ?>" alt="flecha-banner" style="position: absolute;top: 85.5%;left: 4.8%;">
        <img src="<?php echo e(url('images/spa1.jpg')); ?>" alt="eventos-especiales" style="width: 100%;height: 30em;margin-top: 5%;" class="img-btn">
      </div>
     <div style="width: 40%;">
      ...
      <img src="<?php echo e(url('images/complemento-es.png')); ?>" alt="complemento" style="position:  absolute;left: 42%;margin-top: 1%;width: 56%;z-index: 1;">
       <img src="<?php echo e(url('images/flecha-banner.png')); ?>" alt="flecha-banner" style="position: absolute;top: 85.5%;left: 96.4%;transform:  rotate(180deg);z-index: 2;">
    </div>
