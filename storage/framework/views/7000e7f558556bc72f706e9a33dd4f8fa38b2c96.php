...
<head>
  ...
  <meta name="keywords" content="Gimnasio, gym colina,  colina campestre, gimnasio en iberia, gimnasio en suba, gimnasio en niza, ejercicio, entrenamiento, turco, centro de entrenamiento deportivo, equipos deportivos, gimnasio barato económico, entrenador, entrenamiento personalizado, entrenamiento funcional, trx, crossfit.">
    ...
    <meta name="keywords" content="emotion, gym, buena forma, gimnacio, <?php echo $__env->yieldContent('keywords'); ?>">
    <script defer src="https://use.fontawesome.com/releases/v5.0.12/js/all.js" integrity="sha384-Voup2lBiiyZYkRto2XWqbzxHXwzcm4A5RfdfG6466bu5LqjwwrjXCMBQBLMWh7qR" crossorigin="anonymous"></script>
    <?php echo $__env->yieldContent('meta'); ?>
    <?php echo $__env->make('user.includes.style', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('user.includes.google', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <style media="screen">
        .pac-container {
            z-index: 9999;
        }
...
<?php if(isset($wpaper->tipo_archivo) && $wpaper->tipo_archivo == 'imagen'): ?>
background:url('<?php echo e(url('images/wallpapers/'.$wpaper->link_imagen)); ?>') no-repeat; background-size: 100%;
    background-attachment: fixed;
<?php endif; ?>

<?php if(isset($wpaper->tipo_archivo) && $wpaper->tipo_archivo == 'video'): ?>
...
<video id="video" autoplay preload="auto" loop muted="muted">
    <source src="<?php echo e(url('videos/'.$wpaper->link_imagen.'.webm')); ?>" type="video/webm"/>
        <source src="<?php echo e(url('videos/'.$wpaper->link_imagen.'.mp4')); ?>" type="video/mp4"/>
            <source src="<?php echo e(url('videos/'.$wpaper->link_imagen.'.ogg')); ?>" type="video/ogg"/>
            </video>
            <?php endif; ?>
            <?php if(isset($wpaper->tipo_archivo) && $wpaper->tipo_archivo == 'video'): ?>
                <div class="negro">
...
<?php echo $__env->yieldContent('body'); ?>
            ...
            <!--/.Modal: QUick look -->
            <?php echo $__env->make('user.includes.cart', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      ...
      <footer class="mifoot" style="background-image: url('http://127.0.0.1:8000/images/black-bar.jpg');background-position: 33%;background-repeat: no-repeat;height: 22em;">
            ...
            <?php echo $__env->make('user.includes.script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo Html::script('js/frontend.js'); ?>
            ...
            <script type="text/javascript">
                ...
                .then(function(token) {
                    $.ajax({
                        url: '<?php echo e(url("api/push_post")); ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: {
