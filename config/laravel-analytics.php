...
return
    ...
    [
         ...
         */
        'siteId' => 'ga:'.env('ANALYTICS_SITE_ID'),
         ...
         */
        'clientId' => env('ANALYTICS_CLIENT_ID').'.apps.googleusercontent.com',
         ...
         */
        'certificatePath' => storage_path('laravel-analytics/tauret-computadores-3dc97b0a032d.p12'),
