  ...
  .img-btn:hover {
   ...
   <section style="margin-top: 5%;">
    ...
    <img src="{{url('images/flecha-banner.png')}}" alt="left-arrow" style="position: absolute;left: 0.9%;top: 12%;">
    	<img src="{{url('images/banner-principal-deportes.png')}}" alt="banner-principal-deportes" style="width: 98%;">
    ...
    <section style="width: 100%;display:  flex;justify-content:  center;">
    	<img src="{{url('images/banner-secundario-deportes.png')}}" alt="banner-secundario-deportes" style="margin-top: -2%;width: 98.2%;">
    </section>
    ...
    <section style="width: 100%;display: flex;flex-direction: row;">
    	...
    	<img src="{{url('images/foto-deportes.png')}}" alt="deportes" style="margin-left: -7%;width: 100%;">
    	</div>
    	<div style="width: 50%;margin: 10% 4% 0% 0%;font-family: 'light';">
    		...
    		<br>
    		<img src="{{url('images/leer-mas-deportes.png')}}" alt="leer-mas-deportes" style="margin-left: 7%;">
    	</div>
	</section>
	<section style="width: 100%;display: flex;flex-direction: row-reverse;margin-top:  -8.6%;">
    	...
    	<img src="{{url('images/foto-deportes.png')}}" alt="deportes" style="margin-right: -10%;width: 100%;">
    	</div>
    	<div style="width: 50%;margin: 10% 0% 0% 4%;font-family: 'light';">
			...
			<br>
			<img src="{{url('images/leer-mas-deportes.png')}}" alt="leer-mas-deportes">
    	</div>
	</section>
	...
	<section style="margin: 4% 0%;">
		<img src="{{url('images/banner-terciario-deporte.png')}}" alt="banner-terciario-deporte" style="width: 102%;margin-left:  -1%;">
	</section>
    ...
    <section class="container" style="margin-bottom: 6%;">
    	<div>
    		<img src="{{url('images/danza.png')}}" alt="danza">
    	</div>
    	<div style="width: 48%;border-radius:  1%;box-shadow:  black 0px 0px 10px;padding: 2%;position: absolute;top: 77%;left: 48%;background:  #fff;">
    		...
    		<br>
    		<img src="{{url('images/leer-mas-deportes.png')}}" alt="leer-mas-deportes" style="margin-left: 7%;float: right;" class="img-btn">
    	</div>
	</section>

	<section class="container" style="display: flex;justify-content: flex-end;margin-bottom: 20%;">
		<div>
			<img src="{{url('images/danza.png')}}" alt="karate">
		</div>
