...
.circle-box {
   ...
   <section style="margin-top: 5%;">
    ...
    <img src="{{url('images/flecha-banner.png')}}" alt="left-arrow" style="position: absolute;left: 8.3%;top: 14%;">
    	<img src="{{url('images/banner-principal-rest.png')}}" alt="banner-principal-rest">
    	<img src="{{url('images/flecha-banner.png')}}" alt="right-arrow" style="transform: rotate(180deg);position: absolute;left: 90.08%;top: 14%;">
    	</div>
    </section>
    <section class="container" style="width: 100%;display:  flex;justify-content:  center;">
    	<img src="{{url('images/banner-secundario-rest.png')}}" alt="banner-secundario-rest" style="margin-top: -2%;">
    </section>
    <section class="container" style="width: 100%;display:  flex;justify-content:  center;margin-left: 1%;">
    	<img src="{{url('images/txt-rest.png')}}" alt="text-rest" style="margin-top: 2%;">
    </section>
    ...
    <section class="container" style="width: 100%;display: flex;justify-content: flex-start;">
    	...
    	<div style="margin-top: 14%;font-family: 'light';width: 30%;">
			...
			<br>
			<div>
				<img src="{{url('images/leer-mas.png')}}" alt="leer-mas" class="img-btn">
			</div>
    	</div>
    </section>
	<section class="container" style="margin-top: 15%;margin-bottom: 5%;">
      		...
      		<img src="{{url('images/decoracion-spa.png')}}" alt="decoracion">
      		<img src="{{url('images/descargar-menu.png')}}" alt="descargar-menu" style="margin-left: 89%;">
      		</div>
    	</section>

    	<section class="container" style="width: 100%;display: flex;justify-content: space-around;flex-wrap: wrap;margin: 4% 0%;">
    		<div class="food-box">
    			<img src="{{url('images/comida.png')}}" alt="food-photo">
    			<h4 style="color: #7ab527;">Nombre del Plato</h4>
    			<img src="{{url('images/estrellas.png')}}" alt="estrellas">
    	...
    	<section class="container" style="margin-top: 15%;margin-bottom: 5%;">
      		...
      		<img src="{{url('images/decoracion-rest.png')}}" alt="decoracion-rest" style="width: 35%;">
      		</div>
    	</section>
