...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
		<a href="{{ route('admin.user.create') }}" class="btn btn-primary col-sm-3"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Usuario</a>
	</div>
</div>
